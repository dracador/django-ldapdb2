...
class LDAPField(django_fields.Field, RenderLookupProtocol):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param ordering_rule: Override the LDAP ordering rule for this field.
                              The fields provided by us already have the correct ordering rules set.
    ...
    def from_db_value(self, value, expression, connection) -> bytes | str | list[str] | None:  # noqa: ARG002
        if value is None:
            if self.null:
                return value
